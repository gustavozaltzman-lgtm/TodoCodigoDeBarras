...
export const secondaryButtonClass =
  "cursor-pointer rounded-md border border-border px-5 py-2.5 text-sm font-medium text-secondary transition-colors hover:border-accent hover:text-primary";
export const dangerButtonClass =
  "cursor-pointer text-sm font-medium text-destructive transition-colors hover:underline";
